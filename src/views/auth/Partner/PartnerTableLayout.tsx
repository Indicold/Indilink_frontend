...
// The TableLayoutPartner component takes a prop called AllStore, presumably for rendering data.

const TableLayoutPartner = ({ AllStore, tableHead, type }: any) => {
...
export default TableLayoutPartner
