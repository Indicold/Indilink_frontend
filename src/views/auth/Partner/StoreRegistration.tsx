...
const StoreRegistration = () => {
    ...
    const [CAShow, setCAShow] = useState<any>(false);
    const [CAModal, setCAModal] = useState<any>(false);
    const [compShow, setCompShow] = useState<any>(false);
    const [compModal, setCompModal] = useState<any>(false);
    const [ACUShow, setACUShow] = useState<any>(false);
    const [ACUModal, setACUModal] = useState<any>(false);
    const [condensorShow, setCondensorShow] = useState<any>(false);
    const [condensorModal, setCondensorModal] = useState<any>(false);
    const [AMCShow, setAMCShow] = useState<any>(false);
    const [AMCModal, setAMCModal] = useState<any>(false);
    const [IOTShow, setIOTShow] = useState<any>(false);
    const [IOTModal, setIOTModal] = useState<any>(false);
    const [ITShow, setITShow] = useState<any>(false);
    const [ITModal, setITModal] = useState<any>(false);
    const [genShow, setGenShow] = useState<any>(false);
    const [genModal, setGenModal] = useState<any>(false);
    const [MHEShow, setMHEShow] = useState<any>(false);
    ...
    let payload={
        ...
        asset_id:'INDI01AAAA8'|| 'INDI01AAAA9'

      }
    const [dataa, setData] = useState<any>(payload || {
        chamber_ids:[3]
    });
...
{CAModal && <CAEquipmentsModal modal={CAModal} formD={dataa} update={setData} setModal={setCAModal} />}

{compModal && <CompressorModal modal={compModal} formD={dataa} update={setData} setModal={setCompModal} />}

{ACUModal && <ACUModall modal={ACUModal} formD={dataa} update={setData} setModal={setACUModal} />}

{condensorModal && <CondensorDetailsModal modal={condensorModal} formD={dataa} update={setData} setModal={setCondensorModal} />}

{AMCModal && <AMCDetailModal modal={AMCModal} formD={dataa} update={setData} setModal={setAMCModal} />}

{IOTModal && <IOTDetailModal modal={IOTModal} formD={dataa} update={setData} setModal={setIOTModal} />}

{ITModal && <ITDetailModal modal={ITModal} formD={dataa} update={setData} setModal={setITModal} />}

{genModal && <GeneratorDetailModal modal={genModal} formD={dataa} update={setData} setModal={setGenModal} />}

{MHEModal && <MHEDetailsModal modal={MHEModal} formD={dataa} update={setData} setModal={setMHEModal} />}

{SEModal && <SolarInverterModal modal={SEModal} formD={dataa} update={setData} setModal={setSEModal} />}
                ...
                <FormContainer>
                    <div className="flex">
                        <FormItem
                            ...
                            <select className='border flex h-11 w-full input input-md h-11 focus:ring-indigo-600 focus-within:ring-indigo-600 focus-within:border-indigo-600 focus:border-indigo-600' name="city_id" onChange={(e:any)=>handlechange(e)}>
                    ...
                    <div className="flex">
                        ...
                        >
                            <div className='border flex h-11 w-full input input-md h-11 focus:ring-indigo-600 focus-within:ring-indigo-600 focus-within:border-indigo-600 focus:border-indigo-600'>
                                <input className='w-2/3 border-0' name='total_tonnage' onChange={(e:any)=>handlechange(e)} type='text' placeholder='Enter value' />
        ...
        <select
                   ...
                   <p className='text-[red]'>{errors && errors.no_of_chambers}</p>     
                    ...
                    <div className="flex">
                        ...
                        >
                            <div className='border flex h-11 w-full input input-md h-11 focus:ring-indigo-600 focus-within:ring-indigo-600 focus-within:border-indigo-600 focus:border-indigo-600'>
                                <input className='w-2/3 border-0' type='text' onChange={(e:any)=>handlechange(e)} name='ante_room_area' placeholder='Enter value' />
                                <select className='border-0'>
                   ...
                   <p className='text-[red]'>{errors && errors.total_number_of_docks}</p>     
                    ...
                    <div className="flex">
                        ...
                        >
                            <div className='border flex h-11 w-full input input-md h-11 focus:ring-indigo-600 focus-within:ring-indigo-600 focus-within:border-indigo-600 focus:border-indigo-600'>
                                <input className='w-2/3 border-0' type='text' onChange={(e:any)=>handlechange(e)} name='total_office_space' placeholder='Enter value' />
                                <select className='border-0'>
                                    <option>Square feet</option>
                                    <option>B</option>
                                </select>
                    ...
                    <div className="flex">
                        ...
                        >
                            <div className='border flex h-11 w-full input input-md h-11 focus:ring-indigo-600 focus-within:ring-indigo-600 focus-within:border-indigo-600 focus:border-indigo-600'>
                                <input className='w-2/3 border-0' type='text' onChange={(e:any)=>handlechange(e)} name='processing_area' placeholder='Enter value' />
                                <select className='border-0'>
                                    <option>Square feet</option>
                                    <option>B</option>
                                </select>
                       ...
                       <p className='text-[red]'>{errors && errors.processing_area}</p> </FormItem>
                        ...
                        >
                            <div className='border flex h-11 w-full input input-md h-11 focus:ring-indigo-600 focus-within:ring-indigo-600 focus-within:border-indigo-600 focus:border-indigo-600'>
                                <input className='w-2/3 border-0' type='text' onChange={(e:any)=>handlechange(e)} name='parking_area' placeholder='Enter value' />
                                <select className='border-0'>
                                    <option>Square feet</option>
                                    <option>B</option>
                                </select>
