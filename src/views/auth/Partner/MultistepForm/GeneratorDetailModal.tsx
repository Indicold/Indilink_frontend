...
import { handleStoreTable, messageView, validateGeneratorForm, onkeyDownforNumSpecialCharcter, onkeyDownNew, messageViewNew, onPasteDefault } from '@/store/customeHook/validate'
...
const GeneratorDetailModal: React.FC<MajorityHolderModalProps> = ({
    ...
    setting the new state object as the updated state using the setData function. This code is
    executed only once, when the component is mounted, as the dependency array [] is empty. */
    useEffect(()=>{
