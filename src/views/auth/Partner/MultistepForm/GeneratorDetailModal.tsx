...
const GeneratorDetailModal: React.FC<MajorityHolderModalProps>  = ({modal, formD, update,setModal}) => {
       ...
       const handleChange=(e:any)=>{
        ...
        console.log("newData",newData);
            ...
            const handlesave = () => {
                ...
                handleStoreTable('partner/store/generator',data,setModal,formD,update,"generator_ids")
