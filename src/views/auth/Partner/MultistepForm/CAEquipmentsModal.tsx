...
const CAEquipmentsModal: React.FC<MajorityHolderModalProps>  = ({modal, formD, update,setModal}) => {
    ...
    const [data,setData]=useState({
       ...
       const handleChange=(e:any)=>{
        ...
        setData(newData);
          ...
          // function to handle modal form submission and api call
            const handlesave = async () => {
                // custom hook to handle api call
                handleStoreTable('partner/store/ca-equipment',data,setModal,formD,update,"ca_equipment_ids")
