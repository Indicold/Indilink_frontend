...
import { handleStoreTable, messageView, messageViewNew, onkeyDownforNumSpecialCharcter, validateIOTForm } from '@/store/customeHook/validate'
                    ...
                    <div className="my-auto relative w-full max-w-md max-h-full">
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="px-6 py-6 lg:px-8">
                                ...
                                <div className=" bg-gray-100  m-auto mt-2 rounded-md p-2 w-[100%] md:flex lg:flexex">
                                    <FormItem
                                ...
                                <div className=' mt-2 rounded-md p-2 w-[100%] md:flex lg:flex'>
                                <Button
