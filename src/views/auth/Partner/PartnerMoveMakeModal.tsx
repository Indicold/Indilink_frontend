                ...
                <div className="my-auto relative w-full max-w-[500px] max-h-full rounded-[13px]">
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div className='p-4'>
                            ...
                            <p className='mx-auto text-center text-[red] text-p-error-hight'>{error && error?.make}</p>
                            ...
                            <p className='mx-auto text-center text-[red] text-p-error-hight'>{error && error?.model}</p>
