...
/**
 * The `useApiFetch` function is a custom hook in TypeScript that fetches data from an API endpoint,
 ...
 * @returns The `useApiFetch` function returns an object with the following properties:
 */
